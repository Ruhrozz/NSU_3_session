...
class LinearModel:
    def __init__(self, in_features, n_classes):
        ...
        self.weight = tor4.tensor(np.random.normal(size=(in_features, n_classes)), requires_grad=True)
        self.implicit_bias = np.array([-0.5])
...
def get_criterion():
    def criterion(logits, labels):
        """Calculate mean squared error between sigmoids and labels"""
